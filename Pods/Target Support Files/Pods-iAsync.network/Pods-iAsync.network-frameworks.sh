...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-iAsync.network/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'iAsync_async.framework'
  install_framework 'iAsync_network.framework'
  install_framework 'iAsync_utils.framework'
fi
