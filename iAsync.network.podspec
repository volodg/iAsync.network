#
#  Be sure to run `pod spec lint iAsync.network.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "iAsync.network"
  s.version      = "0.0.2"
  s.summary      = "iAsync.network lib developed to make network async programming easier"

  s.description  = <<-DESC
                   iAsync is a set of IOS libraries that aims to make asychronous programming easy for for IOS developers. It uses functional programming ideas to solve Callback Hell problem.
  ...
  s.source = { :git => "https://github.com/volodg/iAsync.network.git", :tag => "0.0.2" }
  ...
  s.dependency "iAsync.reactiveKit"#, "~> 0.0.1"
